...
public record BookAnalysisDto(
    ...
    int TotalWordCount,
    DateTime? CrawledAt,
    string BackgroundAiStatus,
    string? BackgroundAiJobId,
    DateTime? BackgroundAiRequestedAt,
    DateTime? BackgroundAiFinishedAt,
    string BackgroundAiMessage,
...
public record BookAnalysisUpsertDto(
    ...
    string BackgroundAiStatus = "idle",
    string? BackgroundAiJobId = null,
    DateTime? BackgroundAiRequestedAt = null,
    DateTime? BackgroundAiFinishedAt = null,
    string BackgroundAiMessage = "",
    string WorldBuildingMethod = "",
    string PowerSystemDesign = "",
    string EnvironmentDescription = "",
